...
public class Table4_4 extends TableMain {
    ...
    private Tile[][] tile4_4 = { { tile1, tile2, tile3, tile4 }, { tile5, tile6, tile7, tile8 }, { tile9, tile10, tile11, tile12 }, 
    ...
    public Table4_4(JFrame f) {
        ...
        (tile1.returnBTn()).setBounds((int) (centerX - (2*size.getWidth()) - (2*margin + margin1)), (int) (centerY - (2*size.getHeight()) - (2*margin + margin1)),
                size.width, size.height);
        (tile2.returnBTn()).setBounds((int) (centerX - size.getWidth() - margin), (int) (centerY - (2*size.getHeight()) - (2*margin + margin1)),
                size.width, size.height);
        (tile3.returnBTn()).setBounds((int) (centerX + margin1), (int) (centerY - (2*size.getHeight()) - (2*margin + margin1)),
                size.width, size.height);
        (tile4.returnBTn()).setBounds((int) (centerX + size.getWidth() + (2*margin)), (int) (centerY - (2*size.getHeight()) - (2*margin + margin1)),
                size.width, size.height);
        (tile5.returnBTn()).setBounds((int) (centerX - (2*size.getWidth()) - (2*margin + margin1)), (int) (centerX - size.getWidth() - margin),
                size.width, size.height);
        (tile6.returnBTn()).setBounds((int) (centerX - size.getWidth() - margin), (int) (centerX - size.getWidth() - margin),
                size.width, size.height);
        (tile7.returnBTn()).setBounds((int) (centerX + margin1), (int) (centerX - size.getWidth() - margin),
                size.width, size.height);
        (tile8.returnBTn()).setBounds((int) (centerX + size.getWidth() + (2*margin)), (int) (centerX - size.getWidth() - margin),
                size.width, size.height);
        (tile9.returnBTn()).setBounds((int) (centerX - (2*size.getWidth()) - (2*margin + margin1)), (int) (centerY + margin1),
                size.width, size.height);
        ...
        (tile11.returnBTn()).setBounds((int) (centerX + margin1), (int) (centerY + margin1),
                size.width, size.height);
        (tile12.returnBTn()).setBounds((int) (centerX + size.getWidth() + (2*margin)), (int) (centerY + margin1),
                size.width, size.height);
        (tile13.returnBTn()).setBounds((int) (centerX - (2*size.getWidth()) - (2*margin + margin1)), (int) (centerY + size.getWidth() + (2*margin)),
                size.width, size.height);
        (tile14.returnBTn()).setBounds((int) (centerX - size.getWidth() - margin), (int) (centerY + size.getWidth() + (2*margin)),
                size.width, size.height);
        (tile15.returnBTn()).setBounds((int) (centerX + margin1), (int) (centerY + size.getWidth() + (2*margin)),
                size.width, size.height);
        (tile16.returnBTn()).setBounds((int) (centerX + size.getWidth() + (2*margin)), (int) (centerY + size.getWidth() + (2*margin)),
                size.width, size.height);
